$(document).ready(()=>{
    ...
    $(window).scroll(()=>{
        if ($(window).scrollTop() > 50) $(".navbar").addClass("navbar-scrolled");
    ...
    const animateElements = ()=>{
        $(".animate-on-scroll").each(function() {
            ...
            if (elementBottom > viewportTop && elementTop < viewportBottom - 100) $(this).addClass("animate");
        });
    };
    ...
    $(".navbar-nav a").on("click", ()=>{
        if ($(window).width() < 992) $(".navbar-collapse").collapse("hide");
    });
});

//# sourceMappingURL=co-working space.44983732.js.map
